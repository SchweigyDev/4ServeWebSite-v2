...
interface UserConfig extends DefaultEnvironmentOptions {
   ...
   *
   * CTA under this field could change in the future and might NOT follow semver.
   ...
   * Legacy options
   *
   * CTA under this field only follow semver for patches, they could be removed in a
