    ...
    return (
        ...
        >
            ...
            >
                ...
                <div style={{ flex: "1 1 320px", minWidth: "280px", fontSize: "1.2rem" }}>
                    ...
                    >
                        ...
                        <h2 style={{ margin: 0, fontSize: "2.2rem", fontWeight: "bold", lineHeight: 1 }}>
                            4Serve
                        </h2>
                    </div>
            ...
            <style>{`
                ...
                .footer-center-button:hover { color: #00D4FF; transform: scale(1.05); }
                ...
                @media (max-width: 768px) {
                    ...
                    .footer-center-title { text-align: center; margin-bottom: 12px; }
                    .footer-center-nav {
                        display: grid;
                ...
                .logo-hover:hover h2 { filter: drop-shadow(0 0 12px #00D4FF); transform: scale(1.05); }
